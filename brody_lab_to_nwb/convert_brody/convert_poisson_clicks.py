...
nwbfile_path = base_path / "electrodes_testing.nwb"
...
# Run the conversion
session_start_time = datetime(*[int(x) for x in session_name.split("_")[1:]])
session_str = str(session_start_time)[:10]
...
metadata['NWBFile'].update(session_description=session_description, session_start_time=str(session_start_time))
